...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop teamwork and compete in basketball scrimmages",
    ...
    "Drama Club": {
        "description": "Practice acting, stage production, and put on performances",
    ...
    "Debate Team": {
        "description": "Learn argumentation, public speaking, and debate strategies",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if normalized_email in participant_emails:
